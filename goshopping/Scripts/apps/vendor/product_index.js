$(document).ready(function () {
        ...
        "columns": [
            {
                "data": "rowid", "width": "30px", "orderable": false, "render": function (data) {
                    return '<a class="popup"  title="修改記錄" href="/Vendor/Products/Edit/' + data + '"><i class="fas fa-edit fa-2x"></i></a>' +
                        ...
                        '<a class="popup" title="商品描述" href="/Vendor/Products/Remark/' + data + '"><i class="fas fa-file-alt fa-2x"></i></a>';
                }
            },
            {
            ...
            { "data": "product_content", "Width": "100px" },
            {
                "data": "deadline_end", "width": "60px", "title": "訂單日期",
                "render": function (data) { return moment(data).format("YYYY/MM/DD"); }
            },
            {
                "data": "deadline_start", "width": "60px", "title": "訂單日期",
                "render": function (data) { return moment(data).format("YYYY/MM/DD"); }
            },
            { "data": "product_tag", "autoWidth": "60px" },
    ...
    function OpenPopup(pageUrl) {
        ...
        $dialog = $('<div class="popupWindow"style="overflow:auto;z-index:99;"></div>')
            .html($pageContent)
            .dialog({
                draggable: true,
                autoOpen: false,
