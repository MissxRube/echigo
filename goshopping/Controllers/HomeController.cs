...
namespace goshopping.Controllers
{
    public class HomeController : Controller
    {
        ...
        [HttpPost]
        public ActionResult About(Applies model)
        {
            if (!ModelState.IsValid) return View(model);
            Applies apply = new Applies();
            apply.company = model.company;
            apply.company_tel = model.company_tel;
            apply.company_email = model.company_email;
            apply.remark = model.remark;
